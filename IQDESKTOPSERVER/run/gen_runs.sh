...
CUSTOMCONTENT=${19}
CUSTOMCONTENTPW=${20}
IQREPORT_TEMPLATE=${21}
IQREPORT_LICENSE_KEY=${22}
NONMEM_LICENSE_KEY=${23}
MONOLIX_LICENSE_KEY=${24}
VNC_PRIVATE_KEY=${25}
VNC_CERTIFICATE=${26}
AWS_ACCESS_KEY_ID=${27}
AWS_SECRET_ACCESS_KEY=${28}
PRIVILEGED=${29}
MOUNTBASENAME=${30}

MOUNT_1_LABEL=${31}
MOUNT_1_SERVER_IP=${32}
MOUNT_1_SERVER_FOLDER=${33} 
MOUNT_1_OPTIONS=${34}

MOUNT_2_LABEL=${35} 
MOUNT_2_SERVER_IP=${36} 
MOUNT_2_SERVER_FOLDER=${37} 
MOUNT_2_OPTIONS=${38} 

MOUNT_3_LABEL=${39}  
MOUNT_3_SERVER_IP=${40}  
MOUNT_3_SERVER_FOLDER=${41}  
MOUNT_3_OPTIONS=${42} 

MOUNT_4_LABEL=${43} 
MOUNT_4_SERVER_IP=${44}  
MOUNT_4_SERVER_FOLDER=${45}  
MOUNT_4_OPTIONS=${46} 

MOUNT_5_LABEL=${47}  
MOUNT_5_SERVER_IP=${48}  
MOUNT_5_SERVER_FOLDER=${49}  
MOUNT_5_OPTIONS=${50} 
...
sed -i "s#%CUSTOMCONTENT_TEMPLATE%#$CUSTOMCONTENT#g" $CUSTOM_YML_FILE
sed -i "s#%CUSTOMCONTENTPW_TEMPLATE%#$CUSTOMCONTENTPW#g" $CUSTOM_YML_FILE
